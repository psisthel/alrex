...
----------------------------------------------------------------------------------
*/
User Function NEOFUN12(nDC1,cLP1)
/*
...
IF !DbSeek("  "+"MV_DIFPES")
   ...
   Replace SX6->X6_CONTEUD  With "10"
   Replace SX6->X6_CONTSPA  With "10"
   Replace SX6->X6_CONTENG  With "10"
...
----------------------------------------------------------------------------------
*/
User Function NEOFUN13(nDC1,cLP1)
/*
Local aSaveArea := GetArea()
Local cLP1      := ""
*/
